...
public class Salary  implements java.io.Serializable {
    ...
    /** full constructor */
    public Salary(Worker worker, String salaryDate, Float salaryBased, Float salaryStandardTime, Float salaryActualTime, Float salaryWeekendTime, Float salaryHolidayTime) {
        this.worker = worker;
