...
public class Worker implements java.io.Serializable {
	...
	/** minimal constructor */
	public Worker(Department department, String workerNo, String workerName,
			String workerSex, Integer workerPermission, Date workerEntryDate,
			String workerId, Date workerBirthDate, String workerBirthPlace,
	...
	public Worker(Department department, String workerNo, String workerName,
			...
			String workerPolitical, String workerNationality,
			String workerEthnic, String workerEducation, String workerPhone,
			String password, Set vacations, Set rewardorpunishments,
			Set salaries, Set cultivations, Set attendances) {
		this.department = department;
		this.workerNo = workerNo;
		this.workerName = workerName;
		this.workerSex = workerSex;
