...
CREATE TABLE `department` (
  `DepartmentOid` int(11) NOT NULL AUTO_INCREMENT,
  `DepartmentNo` varchar(45) NOT NULL,
  `DepartmentName` varchar(45) NOT NULL,
  `FatherDepartmentOid` int(11) DEFAULT NULL,
  PRIMARY KEY (`DepartmentOid`),
...
-- Dump completed on 2015-06-11 15:20:24
